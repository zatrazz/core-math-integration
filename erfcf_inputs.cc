...
main (int argc, char *argv[])
{
  ...
  constexpr const float x_end   = 0x1.41bbf6p+3;
  ...
  std::printf ("# where b in the smallest number such that erfcf(b) ");
  std::printf ("rounds to 0 (to nearest)\n");
